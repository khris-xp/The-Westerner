...
def gameOver(screen, clock, score):
    font = pygame.font.Font('../Infographic/font/subatomic.ttf', 20)
    user_ip = ''
    ...
    while True:
        ...
        draw_text('GAMEOVER', ('#FFF4EB'), 100, screen,
                  (WINDOW_WIDTH / 2 + 3, 140 + 3))
        draw_text('GAMEOVER', ('#DC3535'), 100,
        ...
        pygame.draw.rect(screen, ('#CC3636'), menu_button)
