...
class AllSprites(pygame.sprite.Group):
    def __init__(self):
        ...
        self.bg = pygame.image.load('../Infographic/graphics/other/bg.png').convert()
...
class Gamerun():
    def __init__(self, screen, clock):
        ...
        self.bullets_surf = pygame.image.load(
            '../Infographic/graphics/other/particle.png').convert_alpha()
    ...
    def setup(self):
        tmx_map = load_pygame('../Infographic/data/map.tmx')
    ...
    def display_score(self):
        ...
        self.font = pygame.font.Font('../Infographic/font/subatomic.ttf', 50)
